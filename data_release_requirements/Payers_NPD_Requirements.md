...
Payers should: 
1. Create a [Federated Payer Identifier](https://github.com/ftrotter-gov/FederatedPayerIdentifier/blob/main/GeneratingFederatedPayerIdentifiers.md) for their payer organization(s)
...
This is the requirement that generates the [a well-known Payer Plan index file](https://github.com/ftrotter-gov/FederatedPayerIdentifier/blob/main/WellKnownFileFormat.md) beta specification. 

As per the above requirement, Payers can either slack the well-known index file to Fred Trotter on the HTE slack or send a pull request on the [payer well-known index repository](https://github.com/ftrotter-gov/FederatedPayerIdentifier/tree/main/payer_index_files) instead.
